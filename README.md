# Sistemas Operacionais II - 2019.2
Repositório destinado aos trabalhos da disciplina INE5424: Sistemas Operacionais II.
...
## Seminário
> Interrupts in ~~Nanvix~~ (RIOT-OS): hardware interrupts, exceptions, handling, propagation through the network stack, demo case.

## Projeto Final

### Parte 1 - Network device driver

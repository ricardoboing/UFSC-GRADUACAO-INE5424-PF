...
template<> struct Traits<i82557a>: public Traits<Machine_Common>
{
    static const unsigned int UNITS = Traits<Ethernet>::DEVICES::Count<i82557a>::Result;
    static const unsigned int SEND_BUFFERS = 64; // per unit
